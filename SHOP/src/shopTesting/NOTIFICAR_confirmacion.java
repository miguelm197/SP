				...
				if (mail.compareTo("") != 0) {
					...
					this.sendMail(mailEnviar, "ADMINISTRACION_Se aprobó la compra. " + titulo,
							"Hola Karen, <br> <br>" + "Confirmamos que la nueva compra solicitada por " + solicitante
									+ " ha sido aprobada correctamente. <br><br>"
			...
			for (User u : usuarios1) {
				...
				if (mail.compareTo("") != 0) {
					...
					this.sendMail(mailEnviar, "ADMINISTRACION_Se rechazó los presupuestos. "  + titulo,
							"Hola Karen, <br> <br>" + "Confirmamos que los presupuestos de la compra solicitada por " + solicitante
			...
			for (User u : usuarios11) {
				...
				if (mail.compareTo("") != 0) {
					...
					this.sendMail(mailEnviar, "ADMINISTRACION_Se colocó la compra en modo StandBy"  + titulo,
							"Hola Karen, <br> <br>" + "Confirmamos que la nueva compra solicitada por " + solicitante
									+ " ha sido puesta en espera hasta nuevo aviso <br><br>"
