...
public class RO_cargarInfoGral extends ApiaAbstractClass {
	...
	protected void executeClass() throws BusClassException {
		...
		String a = this.getCurrentEntity().getAttribute("SH_RO_CODIGO_COMPRA").getValueAsString();
		int cod;
		...
		try {
			...
			if (estadoActual != "") {
				...
				// ent.getForm("SH_RO_INFO_GRAL").setFormProperty(IProperty.PROPERTY_FORM_HIDDEN,
				// false);
			...
			if (estadoActual.equals("Ingreso de presupuestos")
					...
					|| estadoActual.equals("Solicitar Compra") || estadoActual.equals("Pospuesto")
					|| estadoActual.equals("Cancelado") || estadoActual.equals("Retornada")
					|| estadoActual.equals("Finalizar Compra") || estadoActual.equals("Compra Finalizada")) {

				// ent.getForm("SH_RO_INFO_PRESUPUESTOS").setFormProperty(IProperty.PROPERTY_FORM_HIDDEN,
				// false);

				// Obtenemos todos los presupuestos ingresados por
				// administracion
			...
			if (false || estadoActual.equals("Ingreso de presupuestos")
					|| estadoActual.equals("Aprobación de compra, en Dirección")
					|| estadoActual.equals("Solicitar Compra") || estadoActual.equals("Pospuesto")
					|| estadoActual.equals("Cancelado") || estadoActual.equals("Retornada")
					|| estadoActual.equals("Finalizar Compra") || estadoActual.equals("Compra Finalizada")) {

				// ent.getForm("SH_RO_INFO_HISTORIAL").setFormProperty(IProperty.PROPERTY_FORM_HIDDEN,
				// false);
			...
			if (false || estadoActual.equals("Solicitar Compra") || estadoActual.equals("Finalizar Compra")
					|| estadoActual.equals("Compra Finalizada")) {

				// ent.getForm("SH_RO_INFO_SOLICITAR_COMPRA").setFormProperty(IProperty.PROPERTY_FORM_HIDDEN,
				// false);
			...
			if (false || estadoActual.equals("Finalizar Compra") || estadoActual.equals("Compra Finalizada")) {

				// ent.getForm("SH_RO_INFO_FINAL").setFormProperty(IProperty.PROPERTY_FORM_HIDDEN,
				// false);
			...
			throw new BusClassException("Ingreso de Id inválido");
		}
	}
}
