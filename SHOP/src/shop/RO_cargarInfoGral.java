...
public class RO_cargarInfoGral extends ApiaAbstractClass {
	...
	protected void executeClass() throws BusClassException {
		...
		if (false 
			...
			this.getCurrentEntity().getAttribute("SH_RO_GRAL_TITULO").setValues(att1);
			this.getCurrentEntity().getAttribute("SH_RO_GRAL_TITULO").setValues(att2);
			this.getCurrentEntity().getAttribute("SH_RO_GRAL_TITULO").setValues(att3);
			this.getCurrentEntity().getAttribute("SH_RO_GRAL_TITULO").setValues(att4);
		...
		if (false 
			...
			Collection att1 = ent.getAttribute("SH_ESTADO_ACTUAL_STR").getValues();
		...
		if (false 
			...
			this.getCurrentEntity().getAttribute("SH_RO_SOL_FECHA_ENTREGA_FEC").setValue(att3);
		...
		if (false 
			...
			this.getCurrentEntity().getAttribute("SH_RO_FIN_FECHA_FEC").setValue(att3);
